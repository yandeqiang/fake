...
class FakeVue {
    ...
    initRender() {
        this._update();
        new _observer_watcher__WEBPACK_IMPORTED_MODULE_1__["Watcher"](this._vm, 'e', this._update.bind(this));
    }
    _update() {
...
function isVnode(vnode) {
    return vnode && Object(src_util_predict__WEBPACK_IMPORTED_MODULE_0__["isDef"])(vnode.sel);
}
